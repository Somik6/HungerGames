...
public class LeaveCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (session == null) {
			sender.sendMessage(plugin.getBroadcaster().styleMessage("You aren't in a session!"));
			return true;
		}
		if (session.isStarted()) {
			sender.sendMessage(plugin.getBroadcaster().styleMessage("You can't leave a session until it ends!"));
			return true;
		}
