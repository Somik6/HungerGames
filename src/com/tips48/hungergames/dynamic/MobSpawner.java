...
public class MobSpawner 
{
	...
	public void handlePlayerMoveEvent(PlayerMoveEvent event)
	{
		...
		if (doSpawnMob(player) && plugin.getGameManager().getGameSession().isPlayer(player))
		{
			event.getPlayer().getWorld().spawnCreature(getLocation(player), getEntity(player));
		}
	}

	private boolean doSpawnMob(Player player)
	{
